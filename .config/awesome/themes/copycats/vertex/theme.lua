...
theme.icon_dir                                  = gears.filesystem.get_configuration_dir() .. "themes/copycats/vertex/icons"
theme.wallpaper                                 = gears.filesystem.get_configuration_dir() .. "themes/copycats/vertex/wall.png"
