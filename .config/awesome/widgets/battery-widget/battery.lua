...
-- https://github.com/streetturtle/awesome-widgets/tree/master/battery-widget
...
local function worker(args)
    ...
    local warning_msg_icon = args.warning_msg_icon or HOME .. '/.config/awesome/awesome-widgets/batteryarc-widget/spaceman.jpg'
    ...
    local icon_widget = wibox.widget {
        ...
        layout = wibox.container.margin(nil, 0, 0, 3)
    }
