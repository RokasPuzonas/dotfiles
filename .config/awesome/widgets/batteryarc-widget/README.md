...
This widget is more informative version of [battery widget](https://github.com/streetturtle/awesome-widgets/tree/master/battery-widget).
...
| `warning_msg_icon` | ~/.config/awesome/awesome-widgets/batteryarc-widget/spaceman.jpg | Icon of the warning popup |
...
```lua
local batteryarc_widget = require("awesome-widgets.batteryarc-widget.batteryarc")
...
...
In case of any doubts or questions please raise an [issue](https://github.com/streetturtle/awesome-widgets/issues/new).
