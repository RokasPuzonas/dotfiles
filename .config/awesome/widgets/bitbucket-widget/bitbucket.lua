...
-- https://github.com/streetturtle/awesome-widgets/tree/master/bitbucket-widget
...
local function worker(args)
    ...
    local icon = args.icon or HOME_DIR .. '/.config/awesome/awesome-widgets/bitbucket-widget/bitbucket-icon-gradient-blue.svg'
