...
|---|---|---|
| `icon` | `~/.config/awesome/awesome-widgets/bitbucket-widget/bitbucket-icon-gradient-blue.svg` | Path to the icon |
...
```lua
local bitbucket_widget = require("awesome-widgets.bitbucket-widget.bitbucket")
...
