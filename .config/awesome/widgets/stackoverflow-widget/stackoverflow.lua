...
-- https://github.com/streetturtle/awesome-widgets/tree/master/stackoverflow-widget
...
local function worker(args)
    ...
    local icon = args.icon or HOME_DIR .. '/.config/awesome/awesome-widgets/stackoverflow-widget/so-icon.svg'
