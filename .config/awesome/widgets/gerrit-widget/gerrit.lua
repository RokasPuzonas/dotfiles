...
-- https://github.com/streetturtle/awesome-widgets/tree/master/gerrit-widget
...
local function worker(args)
    ...
    local icon = args.icons or HOME_DIR .. '/.config/awesome/awesome-widgets/gerrit-widget/gerrit_icon.svg'
    ...
    local update_widget = function(widget, stdout, _, _, _)
        ...
        if current_number_of_reviews > previous_number_of_reviews then
            ...
            naughty.notify{
                icon = HOME_DIR ..'/.config/awesome/awesome-widgets/gerrit-widget/gerrit_icon.svg',
