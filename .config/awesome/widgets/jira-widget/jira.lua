...
-- https://github.com/streetturtle/awesome-widgets/tree/master/jira-widget
...
local function worker(args)
    ...
    local icon = args.icon or HOME_DIR .. '/.config/awesome/awesome-widgets/jira-widget/jira-mark-gradient-blue.svg'
