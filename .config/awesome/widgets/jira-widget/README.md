...
| `icon` | `~/.config/awesome/awesome-widgets/jira-widget/jira-mark-gradient-blue.svg` | Path to the icon |
...
```lua
local jira_widget = require("awesome-widgets.jira-widget.jira")
...
